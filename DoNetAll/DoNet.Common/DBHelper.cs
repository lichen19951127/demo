...
namespace DoNet.Common
{
    ...
    public static partial class DBHelper
    {
        ...
        private static readonly string ConnString = "Data Source=127.0.0.1;Initial Catalog=donet;User ID=sa;password=1";// ConfigurationManager.ConnectionStrings["ConnString1505NetA"].ConnectionString;
